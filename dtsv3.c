...
void *timeFunc(UNUSED void *args){
	...
	while(1){
		sleep(); // sleep for a set amount of time 
...
void *grabTask(UNUSED void *args){
	printf("grabber thread created\n");
}
...
int main(UNUSED int argc, UNUSED char *argv[]){
    ...
    pthread_create(&TimeThread, NULL, &timeFunc, NULL);
